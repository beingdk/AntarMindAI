...
public class ThoughtsControllerTests : IClassFixture<TestApiFactory>
{
    ...
    {
        var request = new CreateThoughtRequest("Hello, world!");
    ...
    {
        var request = new CreateThoughtRequest("My first thought");
    ...
    {
        var request = new CreateThoughtRequest(new string('a', 2001));
